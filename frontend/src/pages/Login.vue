<template>
  ...
  <div class="w-full max-w-5xl grid grid-cols-1 md:grid-cols-[1fr_1.5px_1fr] overflow-hidden">
      <div class="p-10 md:p-14 flex flex-col justify-center">
        <div class="mb-10">
          <img :src="'/assets/surveillance/images/newlogo.png'" alt="Kenya Red Cross" class="h-10 w-auto object-contain">
        </div>
  ...
  >
    ...
    />
          ...
          <button
            type="submit"
            :disabled="loading"
            class="w-full bg-red-600 hover:bg-red-700 disabled:bg-red-400 disabled:cursor-not-allowed text-white font-semibold rounded-lg py-3 mb-4 flex items-center justify-center gap-2 transition-colors"
          >
